    ...
    if(isMuteMic && isCameraMute) {
        ...
        if(_audioCall) {
            ...
            [self.muteAudioImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
                make.left.mas_equalTo(self.signalButton.mas_right).offset(1);
            ...
            [self.muteAudioImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
                make.left.mas_equalTo(self.muteVideoImageView.mas_right).offset(1);
                make.centerY.mas_equalTo(self.mas_centerY);
                make.width.mas_equalTo(38);
                make.height.mas_equalTo(38);
            }];
...
- (UIButton *)signalButton {
    if(!_signalButton) {
        ...
        [_signalButton setBackgroundImage:[UIImage imageNamed:(self.isEncrypt ? @"signal_strong_lock.png" : @"signal_strong.png")]
