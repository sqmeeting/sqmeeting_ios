...
#define kIPAD_WIDTH             (LAND_SCAPE_WIDTH/2.3)
...
#define KHomeMeetingLeftSpacing 160.0

#define KCornerRadius 8.0
#define KLeftSpacing (24.0)
#define KLeftSpacing12 (8.0)
...
#define kUPDATEHOMEVIEWNotification @"kUPDATEHOMEVIEWNotification"
...
#define KUpdateHomeView [[NSNotificationCenter defaultCenter] postNotificationName:kUPDATEHOMEVIEWNotification object:nil];
