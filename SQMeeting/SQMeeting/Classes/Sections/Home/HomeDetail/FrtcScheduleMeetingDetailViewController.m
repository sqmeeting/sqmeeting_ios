...
- (void)configUI {
    //_isSystem = [FrtcUserModel fetchUserInfo].isSystemAdmin;
...
- (void)responseScheduledMeetingDetail:(NSArray<FHomeDetailMeetingInfo *> *)detailList
                            detailInfo:(FrtcScheduleDetailModel *)detailInfo
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        FrtcHomeDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"FrtcHomeDetailTableViewCell" forIndexPath:indexPath];
...
- (void)addDetailInfoToCalendar:(NSArray <FrtcScheduleDetailModel *> *)meetingInfos event:(EKEventStore *)eventStore{
    ...
    while (i < meetingInfos.count) {
        ...
        NSString *meetingInfo = [FrtcInvitationInfoManage getShareInvitationMeetingInfo:modelInfo];
        event.notes = meetingInfo;
...
- (void)configCallParameter{
    ...
    //[FLocalInforDefault getMeetingDisPlayName];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[FrtcHomeDetailTableViewCell class]
           forCellReuseIdentifier:@"FrtcHomeDetailTableViewCell"];
