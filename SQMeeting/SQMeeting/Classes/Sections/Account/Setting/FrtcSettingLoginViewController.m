...
@interface FrtcSettingLoginViewController ()<UITableViewDelegate, UITableViewDataSource, PopUpViewControllerDelegate,PopUpRateControllerDelegate,StatusTableViewCellDelegate,FrtcSignLoginProtocol>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 3 && indexPath.row == 2) {
        FrtcAccountUpdatePsdViewController *updatePsdvc = [[FrtcAccountUpdatePsdViewController alloc]init];
