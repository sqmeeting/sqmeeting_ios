...
@interface FrtcAccountController ()<UITableViewDelegate, UITableViewDataSource , PopUpViewControllerDelegate,FrtcSignLoginProtocol>
...
@implementation FrtcAccountController
