...
#define KPositionViewHeight  70
#define KRepeatViewHeight    40
#define kOverlayMessageSpacing 8
...
+ (void)showSendOverlayMessageView:(NSString *)meetingNumber
    ...
    [viewController.view addSubview:sendOverlayMessageView];
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.contentLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(self.headerView.mas_bottom).offset(KLeftSpacing12);
        }];
        
        [self.stackView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.contentLabel.mas_top);
            make.left.equalTo(self.contentLabel.mas_right).offset(KLeftSpacing12);
...
- (void)keyboardWillChangeFrameNotification:(NSNotification *)notification {
    ...
    if (self.contentTextView.isFirstResponder) {
        ...
        CGFloat textViewSpacing = keyboardHeight - KLeftSpacing12 - KPositionViewHeight -
    ...
    if (self.repeatView.numberField.isFirstResponder) {
        [self.stackView setCustomSpacing:keyboardHeight - KPositionViewHeight - KLeftSpacing12 afterView:self.repeatView];
    }
