...
- (void)stopRecordingWithMeetingNumber:(NSString *)meetingNumber{
    [[FrtcHelpers getCurrentVC] showAlertWithTitle:NSLocalizedString(@"MEETING_STOP_RECORD_TITLE", nil) message:NSLocalizedString(@"MEETING_STOP_RECORD_MESSAGE", nil) buttonTitles:@[NSLocalizedString(@"dialog_cancel", nil),NSLocalizedString(@"meeting_stop_record", nil)] alerAction:^(NSInteger index) {
        if (index == 1) {
...
- (void)stopLiveWithMeetingNumber:(NSString *)meetingNumber {
    [[FrtcHelpers getCurrentVC] showAlertWithTitle:NSLocalizedString(@"MEETING_STOP_LIVE_TITLE", nil) message:@"" buttonTitles:@[NSLocalizedString(@"dialog_cancel", nil),NSLocalizedString(@"meeting_stop_live", nil)] alerAction:^(NSInteger index) {
        if (index == 1) {
...
- (void)allowUnmuteWithMeetingNumber:(NSString *)meetingNumber
