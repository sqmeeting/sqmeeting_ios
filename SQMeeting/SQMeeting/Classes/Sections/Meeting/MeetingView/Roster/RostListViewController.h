...
@protocol RostListViewControllerDelegate <NSObject>
...
@interface RostListViewController : UIViewController

@property (nonatomic, weak) id<RostListViewControllerDelegate> delegate;
