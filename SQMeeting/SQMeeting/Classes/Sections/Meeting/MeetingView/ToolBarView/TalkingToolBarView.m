...
- (void)configTalkingView {
    ...
    [self.btnFloatingFrame mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (UIButton *)btnTurnOffCamera {
    if(!_btnTurnOffCamera) {
        ...
        [_btnTurnOffCamera setTitle:@"" forState:UIControlStateDisabled];
...
- (UIButton *)btnParticipent {
    if(!_btnParticipent) {
        ...
        [_btnParticipent addSubview:self.badgeView];
        [self.badgeView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(self.btnParticipent).mas_offset(23);
            make.centerY.equalTo(self.btnParticipent).mas_offset(-23);
        }];
        
        [_btnParticipent addSubview:self.redDotView];
        [self.redDotView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(self.btnParticipent).mas_offset(10);
            make.centerY.equalTo(self.btnParticipent).mas_offset(-23);
