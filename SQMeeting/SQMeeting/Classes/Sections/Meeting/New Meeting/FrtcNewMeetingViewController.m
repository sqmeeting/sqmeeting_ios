#import "FrtcNewMeetingViewController.h"
...
@interface FrtcNewMeetingViewController () <FrtcNewMeetingProtocol>
...
@implementation FrtcNewMeetingViewController
...
- (void)popUpHistoryMeetingVC {
    @WeakObj(self);
    [FrtcHistoryMeetingListView showWithList:self.meetingRoomList selectIndex:^(FNewMeetingRoomListInfo * _Nonnull info) {
        @StrongObj(self)
