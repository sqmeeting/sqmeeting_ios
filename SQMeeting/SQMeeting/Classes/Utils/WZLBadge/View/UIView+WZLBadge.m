...
#define kWZLBadgeDefaultFont				([UIFont boldSystemFontOfSize:10])
...
- (void)badgeInit
{
    if (self.badgeBgColor == nil) {
        self.badgeBgColor = [UIColor colorWithRed:((18)/255.0f) green:((95)/255.0f) blue:((123)/255.0f) alpha:1.0];//[UIColor redColor];
    }
